...
went and investigated the RGBA issue, i tried converting to RGB instead and it worked:
![1767830932916](image/07-01-2026/1767830932916.png)

Jumping out of my seat having solved that and to see the image on bunny:
![1767830989532](image/07-01-2026/1767830989532.png)

Immediately, I tested the recording hoping that it would work.

STARTING a recording was FUN. STOPPING not so much.
![1767831113942](image/07-01-2026/1767831113942.png)

I realised the typo, calmed down and ploughed ahead:
![1767831153694](image/07-01-2026/1767831153694.png)

I managed to get it up, everyones favourite words. A problem but continuing on. i already know the issue. Have no atom on the file
![1767831241568](image/07-01-2026/1767831241568.png)

Just needed to get the uploader to use ffmpeg to package it as mp4. CDN expects the packaged goods not the raw material.
it simply puts the H.264 stream into an MP4 container very fast. I love ffmpeg. It runs everything.
