...
I confirmed both on server and github that the script succeeded. I am aware that the only issue is the .env file being missing.
![1767534703737](image/04-01-2026/1767534703737.png)

I added an exclude to the yaml script for it.

Made some backend changes all worked.

I went to see the portal again and noticed wasnt getting any mqtt data back into the frontend:
![1767537022254](image/04-01-2026/1767537022254.png)

![1767537031151](image/04-01-2026/1767537031151.png)

dev version working so a websocket issue again:
![1767537078491](image/04-01-2026/1767537078491.png)

from testing yesterday I must of not updated the local version to use 443, I updated that and committed my changes:
![1767537211911](image/04-01-2026/1767537211911.png)

I got everything back working so spending some upgrading the frontend.
I've upgraded the hamburger and modified the navigation on mobile screens as offcanvas instead of default slide down effect from bootstrap.

![1767541747736](image/04-01-2026/1767541747736.png)

![1767541754400](image/04-01-2026/1767541754400.png)
