...
in the stream module i added health checks on the ffmpeg process. I assume based on whats happening that the ffmpeg process is being messed up if theres even a slight hiccup from camera to the script. so need a restart mechanism etc.
![1767473186235](image/03-01-2026/1767473186235.png)

The current version seems more stable and reliable. I've improved it enough to move on to the next phase and try to complete release 2.
![1767473280323](image/03-01-2026/1767473280323.png)

I disabled the old processes and enabled the new one:
![1767474076738](image/03-01-2026/1767474076738.png)

I can see from the logs there was an interruption again but it managed to restart and this is fine
![1767475413792](image/03-01-2026/1767475413792.png)
